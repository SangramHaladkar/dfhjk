...
public class SyncServiceHelper {
	...
	@SuppressLint("NewApi")
	public String sendComposeMail(Context context, String flgForForward,String strUserId,String strDistributionId, String arrayAttachementFileName) throws ServerException
	{
		String strMsg = "";
		...
		try
		{
			if(checkConnection(context))
			{
				...
				params.put("filename",arrayAttachementFileName);
				params.put("fwd_flg",flgForForward);
				params.put("sendTextAlert", "false");
