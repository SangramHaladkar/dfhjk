        ...
        try {
            ...
            if (c.getCount() > 0) {
                while (c.moveToNext()) {
                    ...
                    ActivityStringInfo.strDocRights = c.getString(12);
                    ActivityStringInfo.strLogRights = c.getString(13);
                    ActivityStringInfo.strCompanyName = c.getString(8);
                    ActivityStringInfo.strDailyLogHour = c.getString(14);
                    ActivityStringInfo.strSuggestright = c.getString(15);
                    if (ActivityStringInfo.strDailyLogHour.equals(""))
                        ActivityStringInfo.strDailyLogHour = "24";
                    ActivityStringInfo.strMandatoryMsgRight = c.getString(27);
