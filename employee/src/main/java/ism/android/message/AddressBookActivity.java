        ...
        try {
            ...
            if (c.getCount() > 0) {
                while (c.moveToNext()) {
                    ...
                    map.put(DatabaseConstant.key_POSITION_TITLE, c.getString(4));
                    map.put(DatabaseConstant.key_ORG_ID, c.getString(6));
                    map.put(DatabaseConstant.key_ORG_NAME, c.getString(5));
