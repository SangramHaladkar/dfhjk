...
import ism.manager.dashboard.DashboardFragment;
import ism.manager.document.DocumentFragment;
import ism.manager.log.LogFragment;
import ism.manager.message.MessagesFragment;
import ism.manager.login.LoginActivity;
import ism.manager.schedule.ScheduleFragment;
import ism.manager.settings.SettingsFragment;
...
//        tabLayout.addTab(tabLayout.newTab().setText("Settings"));
        ...
        LinearLayout tabLog = (LinearLayout) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
        tabLogText = (TextView) tabLog.findViewById(R.id.tabText);
        tabLogIcon = (ImageView) tabLog.findViewById(R.id.tabIcon);
        tabLogIcon.setImageResource(R.drawable.tablogicon_unselected);
        tabLogText.setText(getResources().getString(R.string.tab_logs));
        tabLayout.getTabAt(3).setCustomView(tabLog);

        LinearLayout tabDashboard = (LinearLayout) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
        tabDashboardText = (TextView) tabDashboard.findViewById(R.id.tabText);
        tabDashboardIcon = (ImageView) tabDashboard.findViewById(R.id.tabIcon);
        tabDashboardIcon.setImageResource(R.drawable.tabdashboardicon_unselected);
        tabDashboardText.setText(getResources().getString(R.string.tab_dashboard));
        tabLayout.getTabAt(4).setCustomView(tabDashboard);

        this.fragment = null;
        if (ActivityStringInfo.selectedTabIndex == 5) {
            showSettings();
        } else {
//            ActivityStringInfo.selectedListItemIndex = 0;
            ...
            switch (tabLayout.getSelectedTabPosition()) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    tabLogIcon.setImageResource(R.drawable.tablogicon_selected);
                    tabLogText.setTextColor(ContextCompat.getColor(MainActivity.this, R.color.colorBlack));
                    getSupportActionBar().setTitle(tabLogText.getText());
                    ...
                    break;
                case 4:
                    tabDashboardIcon.setImageResource(R.drawable.tabdashboardicon_selected);
                    tabDashboardText.setTextColor(ContextCompat.getColor(MainActivity.this, R.color.colorBlack));
                    getSupportActionBar().setTitle(tabDashboardText.getText());
                    fragment = new DashboardFragment();
                    Bundle bundleDashboard = new Bundle();
                    bundleDashboard.putSerializable(DashboardFragment.INFO, stringInfo);
                    fragment.setArguments(bundleDashboard);
                    break;
            }
        }
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                switch (tabLayout.getSelectedTabPosition()) {
                    ...
                    case 3:
                        tabLogIcon.setImageResource(R.drawable.tablogicon_unselected);
                        tabLogText.setTextColor(ContextCompat.getColor(MainActivity.this, R.color.unselected));
                        break;
                    case 4:
                        tabDashboardIcon.setImageResource(R.drawable.tabdashboardicon_unselected);
                        tabDashboardText.setTextColor(ContextCompat.getColor(MainActivity.this, R.color.unselected));
                        break;
                }
            }
...
//        LinearLayout tabMessage = (LinearLayout) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
//        final TextView tabMessageText = (TextView) tabMessage.findViewById(R.id.tabText);
//        final ImageView tabMessageIcon = (ImageView) tabMessage.findViewById(R.id.tabIcon);
//        tabMessageIcon.setImageResource(R.drawable.tabmessageicon_unselected);
//        tabMessageText.setText("Messages");
//        tabLayout.getTabAt(0).setCustomView(tabMessage);
//
//        tabMessage.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                showToast("MessageTabSelected", Toast.LENGTH_SHORT);
//                tabMessageIcon.setImageResource(R.drawable.tabmessageicon_selected);
//                tabMessageText.setTextColor(ContextCompat.getColor(MainActivity.this,R.color.colorBlack));
//            }
//        });
...
//        tabOne.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.tabmessageicon_unselected, 0, 0);
//        tabLayout.getTabAt(0).setCustomView(tabOne);
//
//        TextView tabTwo = (TextView) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
//        tabTwo.setText("Schedule");
//        tabTwo.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.tabschdlicon_unselected, 0, 0);
//        tabLayout.getTabAt(1).setCustomView(tabTwo);
//
//        TextView tabThree = (TextView) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
//        tabThree.setText("Docs");
//        tabThree.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.tabdocuments_unselected, 0, 0);
//        tabLayout.getTabAt(2).setCustomView(tabThree);
//
//        TextView tabFour = (TextView) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
//        tabFour.setText("Log");
//        tabFour.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.tablogicon_unselected, 0, 0);
//        tabLayout.getTabAt(3).setCustomView(tabFour);
//
//        TextView tabFive = (TextView) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
//        tabFive.setText("Dashboard");
//        tabFive.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.tabdashboardicon_unselected, 0, 0);
//        tabLayout.getTabAt(4).setCustomView(tabFive);
//
//        TextView tabSix = (TextView) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
//        tabSix.setText("Idea");
//        tabSix.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.tabideaicon_selected, 0, 0);
...
//        tabSeven.setText("Settings");
//        tabSeven.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.tabsettingsicon_unselected, 0, 0);
...
//        }
    ...
    private void showSettings() {
        ...
        ActivityStringInfo.selectedTabIndex = 5;
