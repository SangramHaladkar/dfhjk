...
//            btn_Request_Off.setVisibility(View.GONE);
    ...
    public void setSchdlAll() {
        ...
        if (Utility.getMandatoryMessage(mContext) != null && ActivityStringInfo.strMandatoryMsgRight.toLowerCase()
                .equals("y")) {
...
//                    ScheduleFragment.this.getActivity().setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
//                } else {
//                    ScheduleFragment.this.getActivity().setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
//                }
