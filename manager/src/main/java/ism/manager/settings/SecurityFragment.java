    ...
    public void setPreviousQuestionAnswer() {
        ...
        try {
            ...
            if (c.getCount() > 0) {
                if (c.moveToFirst()) {
                    do {
                        preSelectedQuestionOne = c.getString(21);
                        ...
                        preSelectedQuestionTwo = c.getString(23);
                        ...
                        preSelectedQuestionThree = c.getString(25);
                        ...
                        ed_SecurityAnswer1.setText(c.getString(22));
                        ed_SecurityAnswer2.setText(c.getString(24));
                        ed_SecurityAnswer3.setText(c.getString(26));
                    }
                    while (c.moveToNext());
                }
                c.close();
